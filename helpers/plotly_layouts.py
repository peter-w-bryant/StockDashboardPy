...
# Function to create a plotly figure with a candlestick chart
def create_plotly(data):

    Ticker =  data["Ticker"].unique()[0] # Get the ticker name

    # Create a figure, with the candlestick chart and passing the ticker name
...
# Function to style the plotly figure.
